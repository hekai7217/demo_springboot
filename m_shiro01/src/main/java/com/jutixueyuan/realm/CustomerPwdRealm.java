 ...
 *   加密后的realm
 */
public class CustomerPwdRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        // 不是明文 加密的 密码
        // 加密的密码是从数据库中获取的
        String credentials = "dcd171b1ae8d58251fbacbf91a89c82d";
        // 盐值  从数据库中获取
        String salt = "abc";
        // 把盐值 进行转换  ByteSource
         ...
         *
         */
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(user,credentials,byteSource,getName());
